...
LEARNING_RATE_DQN = 1e-4    # Taux d'apprentissage pour DQN (Adam optimizer) avant changement de spawn 1e-4

# Exploration (Epsilon-greedy)
EPSILON_START = 0.01         # Valeur initiale d'epsilon
EPSILON_FINAL = 0.01        # Valeur finale d'epsilon (pas 0 pour garder un peu d'explo)
EPSILON_DECAY_FRAMES = 1 # Nombre de frames sur lesquelles epsilon décroît linéairement
...
RND_REWARD_CLIP = 0.5       # Clipping pour les récompenses intrinsèques normalisées
